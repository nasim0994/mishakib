...
import type { ISidebarSubItem } from "@/interface/sidebarInterface";

export default function SidebarSubItems({
  subItems,
}: {
  ...
  if (subItems?.subSubMenu) {
    return (
      <li>
        ...
        >
          <div className="flex items-center gap-1.5">{subItems.title}</div>
